...
function bp_album_picture_edit_link() {
	if (bp_is_my_profile() || is_super_admin())
		echo '<a href="'.bp_album_get_picture_edit_url().'" class="picture-edit">'.__('Edit file','bp-album').'</a>';
}
...
function bp_album_picture_delete_link() {
	if (bp_is_my_profile() || is_super_admin())
		echo '<a href="'.bp_album_get_picture_delete_url().'" class="picture-delete">'.__('Delete file','bp-album').'</a>';
}
...
function bp_album_picture_thumb_url() {
	return  bp_album_get_picture_thumb_url();
}
