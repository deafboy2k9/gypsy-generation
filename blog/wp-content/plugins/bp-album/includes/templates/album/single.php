                	...
                	<div class="picture-outer-container">
                		<div class="picture-inner-container">
                                            ...
                                            jQuery("#jquery_jplayer_1").jPlayer({								
                                                ready: function () {
                                                    jQuery(this).jPlayer("setMedia", {
														<?php if(is_numeric(strpos(bp_album_get_picture_middle_url(),'mp3'))) { ?>
                                                         mp3:"<?php bp_album_picture_middle_url(); ?>"
														<?php } else if(is_numeric(strpos(bp_album_get_picture_middle_url(),'m4a'))) { ?>
														 m4a:"<?php bp_album_picture_middle_url(); ?>"
														 <?php } else if(is_numeric(strpos(bp_album_get_picture_middle_url(),'oga'))) { ?>
							...
							<?php		
								...
								{									
									$correctLink = explode("blog",bp_album_get_picture_middle_url());
									
									if(is_numeric(strpos($correctLink[1],'http')))
									{
									?>
                                    	<img src="<?php echo $correctLink[1]; ?>"/>				                	
                                   <?php 
								   }
								   else
								   {
