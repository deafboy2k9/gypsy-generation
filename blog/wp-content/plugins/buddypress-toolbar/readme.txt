...
* For custom "branding" or special needs a few sections like "Extensions" and "Resource links group" could be hidden from displaying via your active child theme - for more info [see FAQ section here](http://wordpress.org/extend/plugins/buddypress-toolbar/faq/)
...
* *Your free or premium plugin? - [Just contact me with specific data](http://genesisthemes.de/en/contact/)*
...
* Theme: "Genesis Framework" via "Genesis Connect" plugin (premium, by StudioPress)
* Theme: "Builder Framework" via "Builder BuddyPress" plugin (premium, by iThemes)
* Theme: "Infinity (Anti-) Framework" via "BP Template Pack" plugin (free/beta, by PressCrew)
...
* *Your free or premium theme? - [Just contact me with specific data](http://genesisthemes.de/en/contact/)*
...
1. Upload the entire `buddypress-toolbar` folder to the `/wp-content/plugins/` directory
...
* [User support forums](http://wordpress.org/tags/buddypress-toolbar?forum_id=10)
